defmodule DeteccionElixir.Infrastructure.EntryPoint.ApiRest do
  @moduledoc """
  Access point to the rest exposed services
  """
  # alias DeteccionElixir.Utils.DataTypeUtils
  require Logger
  use Plug.Router
  use Timex
  ...
  plug(Plug.Telemetry, event_prefix: [:deteccion_elixir, :plug])
  plug(:dispatch)
  ...
  forward(
    ...
    init_opts:
      PlugCheckup.Options.new(
        json_encoder: Jason,
        checks: DeteccionElixir.Infrastructure.EntryPoint.HealthCheck.checks()
      )
  )

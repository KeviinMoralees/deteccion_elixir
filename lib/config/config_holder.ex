defmodule DeteccionElixir.Config.ConfigHolder do
  use GenServer
  alias DeteccionElixir.Config.AppConfig
  @table_name :deteccion_elixir_config
...
defmodule DeteccionElixir.Config.ConfigHolder.PropertiesLoaderBehaviour do
  alias DeteccionElixir.Config.AppConfig
